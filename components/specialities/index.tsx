...
const Specialities = () => {
  return (
    <div className="flex justify-center bg-primary h-52 sm:h-64 md:h-60 lg:h-44 w-full mt-24">
      <div className="flex flex-col items-center justify-center lg:flex-row lg:justify-between w-[90%]">
        <div className="flex flex-col items-center lg:items-start">
          <h1 className="uppercase text-white text-5xl sm:text-6xl font-heading">
            Specialities
          </h1>
          <p className="text-white opacity-60 text-xl sm:text-2xl font-light text-center lg:text-start">
        ...
        <div className="flex items-center justify-between w-full lg:w-[60%] overflow-x-auto mt-3 md:mt-4 lg:mt-0">
          {[
            ...
            <Image
              className="mr-4 sm:mr-5 md:mr-4 m-h-[200px]"
              alt="tech"
              key={index}
              src={item}
            />
